...
function Loginpage() {
  return (
    ...
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 ">
      <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm bg-gray-900 p-8 rounded-2xl shadow-xl">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form action="#" method="POST" class="space-y-6">
            ...
            <div>
              <div class="flex items-center justify-between">
                ...
                <div class="text-sm">
                  <a href="#" class="font-semibold text-indigo-400 hover:text-indigo-300 hover:underline">Forgot password?</a>
                </div>
              </div>
              <div class="mt-2">
          ...
          <p class="mt-10 text-center text-sm/6 text-gray-400">
            Not a member?
            <a href="#" class="font-semibold text-indigo-400 hover:text-indigo-300 hover:underline">Start a 14 day free trial</a>
          </p>
        </div>
      </div>
    </div>
